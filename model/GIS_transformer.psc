...
Definitions
 ...
 Module("C4")
  ...
  Page(A/A4,Landscape,16,[651,361],100)
   {
   }
  }
 Module("tower9")
 ...
 Module("C3")
  ...
  Page(A/A4,Landscape,16,[651,361],100)
   ...
   -TLine-([288,396],0,73099584,-1)
    ...
    PageLayer(A/A4,Landscape,16,[651,361],100)
     {
...
#STORAGE REAL:5
  ...
  Page(A/A4,Landscape,16,[651,361],100)
   ...
   -Plot-([198,432],0)
    ...
    Graph([0,0],[0,0,576,225],"y")
     ...
     Options = 137
     Units = ""
     Curve(142713080,"EREA",8388608,,,)
     Curve(142713896,"EPTREA",32768,,,)
     }
    }
   -Plot-([198,720],0)
    {
    ...
    Graph([0,0],[0,0,576,225],"y")
     ...
     Options = 137
     Units = ""
     Curve(142714712,"IAERA",8388608,,,)
     Curve(142715528,"IAPTL",32768,,,)
     }
    }
   }
  }
  ...
  Page(A/A4,Landscape,16,[651,361],100)
   ...
   -Plot-([72,342],0)
    ...
    Graph([0,0],[0,0,576,225],"y")
     ...
     Options = 137
     Units = ""
     Curve(142748168,"EREA",8388608,,,)
     Curve(142748984,"EPTREA",32768,,,)
     }
    }
   -Plot-([72,630],0)
    {
  ...
  Page(A/A4,Landscape,16,[651,361],100)
   ...
   -Plot-([108,360],0)
    ...
    Graph([0,0],[0,0,576,225],"y")
     ...
     Options = 137
     Units = ""
     Curve(142779584,"EREA",8388608,,,)
     Curve(142780400,"EPTREA",32768,,,)
     }
    }
   -Plot-([108,648],0)
    {
  ...
  Page(A/A4,Landscape,16,[651,361],100)
   ...
   -Plot-([108,432],0)
    ...
    Graph([0,0],[0,0,576,225],"y")
     ...
     Options = 137
     Units = ""
     Curve(142795904,"EREA",8388608,,,)
     Curve(142796720,"EPTREA",32768,,,)
     }
    }
   -Plot-([108,720],0)
    {
  ...
  Page(A/A4,Landscape,16,[651,361],100)
   ...
   -Plot-([90,666],0)
    ...
    Graph([0,0],[0,0,576,225],"y")
     ...
     Options = 137
     Units = ""
     Curve(142813448,"IAERA",8388608,,,)
     Curve(142814264,"IAPTL",32768,,,)
     }
    }
   -Plot-([90,378],0)
    {
    ...
    Graph([0,0],[0,0,576,225],"y")
     ...
     Options = 137
     Units = ""
     Curve(142811816,"EREA",8388608,,,)
     Curve(142812632,"EPTREA",32768,,,)
     }
    }
   }
  }
  ...
  Page(A/A4,Landscape,16,[651,361],100)
   ...
   -Plot-([234,324],0)
    ...
    Graph([0,0],[0,0,576,225],"y")
     ...
     Options = 137
     Units = ""
     Curve(142851800,"EPTREA",8388608,,,)
     }
    }
   }
  }
  ...
  Page(A/A4,Landscape,16,[651,361],100)
   ...
   -Plot-([576,0],0)
    ...
    Graph([0,0],[0,0,576,225],"y")
     ...
     Options = 137
     Units = ""
     Curve(142882400,"EGISL",8388608,,,)
     Curve(142882808,"EGIST",32768,,,)
     }
    }
   -Plot-([0,0],0)
    {
   ...
   -Plot-([576,288],0)
    ...
    Graph([0,0],[0,0,576,225],"y")
     ...
     Options = 137
     Units = ""
     Curve(142883216,"IABUS1",8388608,,,)
     Curve(142883624,"IABUS2",32768,,,)
     }
    }
   }
  }
  ...
  Page(A/A4,Landscape,16,[651,361],100)
   ...
   -Plot-([990,108],0)
    ...
    Graph([0,0],[0,0,576,225],"y")
     ...
     Options = 137
     Units = ""
     Curve(101871888,"BRKVtowerI2",8388608,,,)
     }
    }
  ...
  Page(A/A4,Landscape,16,[651,361],100)
   ...
   -Plot-([1008,144],0)
    ...
    Graph([0,0],[0,0,576,225],"y")
     ...
     Options = 137
     Units = ""
     Curve(101878008,"BRKVtowerI6",8388608,,,)
     }
    }
   -Wire-([252,342],0,0,-1)
    {
 ...
 Module("GIS")
  ...
  Page(A/A4,Landscape,16,[651,361],100)
   ...
   0.capacitor([432,72],3,0,-1)
    {
    C = "300e-6 [uF]"
    }
   0.ground([432,36],3,0,-1)
    {
    }
   0.annotation([216,144],0,0,-1)
    {
    AL1 = "BUS1"
    AL2 = ""
    }
   0.annotation([792,144],0,0,-1)
    {
    AL1 = "BUS2"
    AL2 = ""
    }
   0.voltmetergnd([468,90],3,0,10)
    {
    Name = "EGISL"
    }
   0.voltmetergnd([576,90],5,0,20)
    {
    Name = "EGIST"
    }
   0.datalabel([18,936],0,0,-1)
    {
    Name = "EGISL"
    }
   0.datalabel([18,972],0,0,-1)
    {
    Name = "EGIST"
    }
   ...
   0.datalabel([90,972],0,0,-1)
    {
    Name = "IABUS2"
    }
   0.pgb([18,936],0,142882400,50)
    {
    Name = "EGISL"
    Group = ""
    Display = "0"
   ...
   0.capacitor([342,180],3,0,-1)
    {
    C = "300e-6 [uF]"
    }
   0.ground([342,180],7,0,-1)
    {
    }
   -Wire-([324,144],0,0,-1)
    {
   ...
   0.capacitor([522,180],3,0,-1)
    {
    C = "300e-6 [uF]"
    }
   0.ground([522,180],7,0,-1)
    {
    }
   -Wire-([504,144],0,0,-1)
    {
   ...
   0.xnode([648,90],0,0,-1)
    {
    Name = "T4"
    }
   0.capacitor([612,72],3,0,-1)
    {
    C = "300e-6 [uF]"
    }
   0.ground([612,36],3,0,-1)
    {
    }
   0.annotation([612,162],0,0,-1)
    {
    AL1 = "BUS1"
    AL2 = ""
    }
   0.capacitor([684,180],3,0,-1)
    {
    C = "300e-6 [uF]"
    }
   0.ground([684,180],7,0,-1)
    {
    }
   -Wire-([612,72],0,0,-1)
    {
   ...
   0.capacitor([432,306],3,0,-1)
    {
    C = "300e-6 [uF]"
    }
   0.ground([432,270],3,0,-1)
    {
    }
   0.capacitor([342,414],3,0,-1)
    {
    C = "150e-6 [uF]"
    }
   0.ground([342,414],7,0,-1)
    {
    }
   -Wire-([324,378],0,0,-1)
    {
   ...
   0.capacitor([522,414],3,0,-1)
    {
    C = "150e-6 [uF]"
    }
   -TLine-([288,378],0,83498184,-1)
    {
    Name = "GIS15"
    Date = 1248851517
    Freq = "50.0"
   ...
   0.ground([432,522],6,0,-1)
    {
    }
   0.arrester([342,522],5,0,30)
    {
    Name = ""
    VSCAL = "828 [kV]"
    ISCAL = "1"
   ...
   0.ground([594,522],2,0,-1)
    {
    }
   0.arrester([684,522],3,0,40)
    {
    Name = ""
    VSCAL = "828 [kV]"
    ISCAL = "1"
   ...
   0.resistor([630,522],2,0,-1)
    {
    R = "16.5 [ohm]"
    }
   -TLine-([324,702],0,83744136,-1)
    {
    Name = "GIS21"
    Date = 1248851517
    Freq = "50.0"
   ...
   0.capacitor([432,630],3,0,-1)
    {
    C = "300e-6 [uF]"
    }
   0.ground([432,594],3,0,-1)
    {
    }
   0.capacitor([342,738],3,0,-1)
    {
    C = "150e-6 [uF]"
    }
   0.ground([342,738],7,0,-1)
    {
    }
   -Wire-([324,702],0,0,-1)
    {
   ...
   0.capacitor([522,738],3,0,-1)
    {
    C = "300e-6 [uF]"
    }
   0.ground([522,738],7,0,-1)
    {
    }
   -Wire-([504,702],0,0,-1)
    {
   ...
   0.xnode([648,648],0,0,-1)
    {
    Name = "T2"
    }
   0.capacitor([612,630],3,0,-1)
    {
    C = "300e-6 [uF]"
    }
   0.ground([612,594],3,0,-1)
    {
    }
   0.capacitor([684,738],3,0,-1)
    {
    C = "150e-6 [uF]"
    }
   0.ground([684,738],7,0,-1)
    {
    }
   -Wire-([612,630],0,0,-1)
    {
   ...
   0.capacitor([432,864],3,0,-1)
    {
    C = "300e-6 [uF]"
    }
   0.ground([432,828],3,0,-1)
    {
    }
   0.capacitor([342,972],3,0,-1)
    {
    C = "150e-6 [uF]"
    }
   0.ground([342,972],7,0,-1)
    {
    }
   -Wire-([324,936],0,0,-1)
    {
 ...
 Module("Main")
  ...
  Page(B/A3,Landscape,16,[651,361],100)
   {
   .GIS([108,126],0,0,-1)
    {
    }
